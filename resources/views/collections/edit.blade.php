...
@section('content')
<div>
    <h1 class="page-header text-overflow">Edit Collections</h1>
</div>
<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <form class="form form-horizontal mar-top" action="{{route('collections.update',$colid)}}" method="POST" enctype="multipart/form-data" id="choice_form">
            @csrf
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="name" value="{{$collections->name}}" placeholder="{{__('Collection Name')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="number" class="form-control" name="price"value="{{$collections->unit_price}}" placeholder="Unit Price" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">{{__('Tags')}}</label>
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="tags" value="{{$collections->search_tag}}" placeholder="Type to add a tag" data-role="tagsinput" required>
                        </div>
                    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea class="editor" name="description" required>{{$collections->description}}"</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <table class="table table-striped" id="example" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            @php
                                $selected='';
                                if(in_array($product->id,$products_collection)){
                                $selected='checked';
                                }
                            @endphp
                            <tr>
                                <td><input type="checkbox" {{__($selected)}} name='products[]' value='{{ __($product->id) }}'></td>
                                <td>
            ...
            <div class="mar-all text-right">
                <button type="submit" name="button" class="btn btn-info">{{ __('Update Collection') }}</button>
            </div>
        </form>
    </div>
</div>
