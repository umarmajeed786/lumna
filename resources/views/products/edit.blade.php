									...
									<div class="col-md-4 col-sm-4 col-xs-6">
										<div class="img-upload-preview">
											@if(strpos($product->thumbnail_img, 'img.alicdn.com') !== false)
												<img loading="lazy"  class="img-md" src="{{ $product->thumbnail_img }}" alt="Image">
											@else
								...
								@if ($product->featured_img != null)
									<div class="col-md-4 col-sm-4 col-xs-6">
										<div class="img-upload-preview">
											...
											@if(strpos($product->featured_img, 'img.alicdn.com') !== false)
												<img loading="lazy"  class="img-md" src="{{ $product->featured_img }}" alt="Image">
											@else
								...
								@if ($product->flash_deal_img != null)
									<div class="col-md-4 col-sm-4 col-xs-6">
										<div class="img-upload-preview">
											...
											@if(strpos($product->flash_deal_img, 'img.alicdn.com') !== false)
												<img loading="lazy"  class="img-md" src="{{ $product->flash_deal_img }}" alt="Image">
											@else
