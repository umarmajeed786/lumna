            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        <li>
                            <a href="{{ route('collections') }}" class="top-bar-item">{{__('Look Book')}}</a>
                        </li>
                        <li>
                    ...
                    <ul class="side-user-menu">
                        ...
                        <li>
                            <a href="{{ route('compare') }}">
                                <i class="la la-refresh"></i><span>{{__('Compare')}}</span>
    ...
    <div class="position-relative logo-bar-area">
        <div class="">
            <div class="container">
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="{{ route('profile') }}" class="nav-box-link">
                ...
                <!--umarmajeed.com added this nav bar-->
  ...
  <ul class="navbar-nav" style="margin: auto;">
      @foreach (\App\Category::all()->where('published', 1)->take(9) as $key => $category)
                                    ...
                                    @endphp
                                     ...
                                     <li class="nav-item">
      <a class="nav-link text-nowrap" href="{{ route('products.category', $category->slug) }}">{{ __($category->name) }}</a>
    </li>
                                @endforeach
