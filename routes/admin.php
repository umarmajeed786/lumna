...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/collections/admin','CollectionController@collections_list')->name('collections.admin');
	Route::get('/collections/create','CollectionController@collections_create')->name('collections.create');
	Route::post('/collections/store', 'CollectionController@collections_store')->name('collections.store');
	Route::post('/collections/{id}/update', 'CollectionController@collections_update')->name('collections.update');
	Route::get('/collections/{id}/edit', 'CollectionController@collections_edit')->name('collections.edit');
	Route::get('/collections/destroy/{id}', 'CollectionController@collections_delete')->name('collections.destroy');
	...
	/* route to get form of product import */
	Route::get('import_products','ImportProductTaobaoController@index')->name('import_products');
    Route::post('save_taobao_products','ImportProductTaobaoController@store_products')->name('save_taobao_products');
