...
Route::get('/collections/detail/{id}', 'CollectionController@collection_details')->name('collections.detail');
Route::get('/collections', 'CollectionController@lookbook')->name('collections');
